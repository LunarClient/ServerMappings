...
You are free to use this data for anything you wish. Aslong as it abides by [our terms of service](https://www.lunarclient.com/terms). You can harness this data through two possible sources:
...
- `banners/<id>.png` - The banner sprite for the provided server ID. These can be animated at 20 frames per second.
