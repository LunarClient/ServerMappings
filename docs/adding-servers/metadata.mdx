...
> These fields are required fo your server to be accepted.
...
> While these fields are not required, they are highly recommended. Enriched sevrers are more likely to utilized when being displayed.
